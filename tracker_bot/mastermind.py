...
start_keyboard_buttons = [[telegram.KeyboardButton('my info')], [telegram.KeyboardButton('create expense')], [telegram.KeyboardButton('delete')]]
    ...
    try:
        ...
        # no state
            ...
            if text == "/start" or text == "cancel delete" or text == "cancel create" or text == "back to home":
                ...
                telebot_instance.sendMessage(chat_id=chat_id,
                                             text="To create an entry, enter the amount you have spent (Use the "
                                                  "buttons or enter yourself)",
